...
$phoneNumber = trim($_POST["Param_phone"]);
$date = trim($_POST["Param_date"]);
$time = trim($_POST["Param_time"]);
$people = trim($_POST["Param_people"]);
...
if (empty($phoneNumber)) {
    $ok = 0;
    $messageInfo .= "<li>$phoneNumberError</li>";
}
...
if ($ok) {
    ...
    $ok = 1 ;
    $messageInfo .= "<li>$email , $date , $people , $time</li>";
}
$messageInfo .= "</ul>";
