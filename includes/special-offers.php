                     ...
                     <div class="tab-content">
                        <div class="tab-pane active show" id="tab-1">
                           <div class="row">
                              ...
                              >
                                 <img
                                    src="./assets/images/specials-1.jpg"
                                    alt=""
                                    class="img-fluid"
                                 />
                              </div>
                        ...
                        <div class="tab-pane" id="tab-2">
                           <div class="row">
                              ...
                              >
                                 <img
                                    src="./assets/images/specials-2.jpg"
                                    alt=""
                                    class="img-fluid"
                                 />
                              </div>
                        ...
                        <div class="tab-pane" id="tab-3">
                           <div class="row">
                              ...
                              >
                                 <img
                                    src="./assets/images/specials-3.jpg"
                                    alt=""
                                    class="img-fluid"
                                 />
                              </div>
                        ...
                        <div class="tab-pane" id="tab-4">
                           <div class="row">
                              ...
                              >
                                 <img
                                    src="./assets/images/specials-4.jpg"
                                    alt=""
                                    class="img-fluid"
                                 />
                              </div>
                        ...
                        <div class="tab-pane" id="tab-5">
                           <div class="row">
                              ...
                              >
                                 <img
                                    src="./assets/images/specials-5.jpg"
                                    alt=""
                                    class="img-fluid"
                                 />
                              </div>
